...
class ChataPagefreelancer extends StatefulWidget {
  const ChataPagefreelancer({super.key});

  @override
  State<ChataPagefreelancer> createState() => _ChataPagefreelancerState();
}

class _ChataPagefreelancerState extends State<ChataPagefreelancer> {
