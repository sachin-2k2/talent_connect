...
class View_Feedbacks extends StatefulWidget {
  const View_Feedbacks({super.key});

  @override
  State<View_Feedbacks> createState() => _View_FeedbacksState();
}

class _View_FeedbacksState extends State<View_Feedbacks> {
  @override
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [Text('feedback'), Text('rating')],
                          ),
                        ),
                      ),
                    );
